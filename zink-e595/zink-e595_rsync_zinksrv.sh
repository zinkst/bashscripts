...
AllowDelete[4]=false
Directories[5]="local/ssd-data/FamilienVideos/Familie-Zink-Videos/2021"
TargetDir[5]="data/zinksrv/FamilienVideos/Familie-Zink-Videos/2021"
MountTestFile[5]=${TGT_ROOT}"data/doNotDelete"
AllowDelete[5]=true
Directories[6]="local/ssd-data/Photos/2021"
TargetDir[6]="data/zinksrv/Photos/Sammlung/2021"
