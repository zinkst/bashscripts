...
SRC_ROOT="/links/"
LOG_ROOT="${SRC_ROOT}/rsync/"
RSYNC_PARAMS="-av --one-file-system --exclude-from ${SRC_ROOT}/rsync/exclude.txt"
...
index="1 2 3 4"
#index="4"
Directories[1]="${CORRECTHOST}/persdata/Henry-local"
TargetDir[1]="data/${CORRECTHOST}/persdata/Henry-local"
